...
var userScore = 0;
var compScore = 0;
var smUser = "(user)".fontcolor("green").fontsize(3).sub();
var smComp = "(comp)".fontcolor("orange").fontsize(3).sub();
...
function win(user, comp) {
    ...
    result_h1.innerHTML = "".concat(hands[user]).concat(smUser, " ").concat(action, " ").concat(hands[comp]).concat(smComp, ". You win!");
...
function lose(user, comp) {
    ...
    result_h1.innerHTML = "".concat(hands[comp]).concat(smComp, " ").concat(action, " ").concat(hands[user]).concat(smUser, ". You lose!");
